...
//UART_ConfigType config_uart = { .UART_BitDateType = UART_8Bit, .UART_ParityType =UART_Parity_disable, .UART_StopBitType=UART_ONE_STOP_BIT , .BaudRateType = UART_BaudRate };
/*******************************************************************************
